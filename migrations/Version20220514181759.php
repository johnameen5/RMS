 ...
 */
final class Version20220514181759 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE imb_customerInvoice (id INT AUTO_INCREMENT NOT NULL, paid_amount DOUBLE PRECISION NOT NULL, returned_amount DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE imb_employee (id INT AUTO_INCREMENT NOT NULL, address_id INT DEFAULT NULL, company_id INT DEFAULT NULL, english_first_name VARCHAR(64) NOT NULL, english_last_name VARCHAR(64) NOT NULL, arabic_first_name VARCHAR(64) NOT NULL, arabic_length_name VARCHAR(64) NOT NULL, phone_number VARCHAR(20) NOT NULL, gender INT NOT NULL, relation_ship_status INT NOT NULL, nationality VARCHAR(2) NOT NULL, employee_status INT NOT NULL, dob DATE NOT NULL, date_of_join DATE NOT NULL, designation INT NOT NULL, termination_date DATETIME NOT NULL, INDEX IDX_152ABBEBF5B7AF75 (address_id), INDEX IDX_152ABBEB979B1AD6 (company_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE imb_inventory (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, supplier_invoice_id INT DEFAULT NULL, branch_id INT DEFAULT NULL, quantity DOUBLE PRECISION DEFAULT NULL, bought_quantity DOUBLE PRECISION DEFAULT NULL, weight DOUBLE PRECISION DEFAULT NULL, bought_weight DOUBLE PRECISION DEFAULT NULL, import_date DATE NOT NULL, expiry_date DATE NOT NULL, INDEX IDX_276C57764584665A (product_id), INDEX IDX_276C577648783C14 (supplier_invoice_id), INDEX IDX_276C5776DCD6CC49 (branch_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
